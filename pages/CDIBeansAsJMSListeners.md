...
These changes are proposed for JMS 2.1 which will be part of Java EE 8. Comments are invited. See [https://java.net/projects/jms-spec/pages/JMS21#How_to_get_involved_in_JMS_2.1 How to get involved in JMS 2.1].

For a summary of the comments made so far, see [[CDIListenerBeanComments|JMS Listener beans: summary of comments]]. 
