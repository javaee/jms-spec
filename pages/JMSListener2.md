...
This page contains version 2 of proposals to simplify the configuration of JMS MDBs in JMS 2.1 and Java EE 8. See the [summary of changes](#changes-from-version-1) compared to [Version 1 of these proposals](JMSListener).

These proposals supersede [version 1](JMSListener).

These proposals were superseded by [version 3](JMSListener3), [version 4](JMSListener4) and [version 5](JMSListener5).
