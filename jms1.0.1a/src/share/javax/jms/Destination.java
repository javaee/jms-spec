...
/*
 * @(#)Destination.java	1.10 98/08/03
 * 
...
/** JMS does not define a standard address syntax. Although this was 
  * considered, it was decided that the differences in address semantics 
  * between existing MOM products was too wide to bridge with a single 
  * syntax. Instead, JMS defines the Destination object which encapsulates 
  ...
  *
  * <P>JMS also supports a client's use of provider-specific address names.
  *
  * <P>Destination objects support concurrent use.
  *
  * <P>A Destination is a JMS administered object.
  *
